...
// Main code
// For console app: int main(int, char**)
int WinMain(
    HINSTANCE hInstance,
...
)
{
    ...
    WNDCLASSEXW wc = { sizeof(wc), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(nullptr), nullptr, nullptr, nullptr, nullptr, L"Ra2yr God", nullptr };
    ::RegisterClassExW(&wc);
    // !!! HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Ra2yr God", WS_OVERLAPPEDWINDOW, 100, 100, (int)(1280 * main_scale), (int)(800 * main_scale), nullptr, nullptr, wc.hInstance, nullptr);
